...
final class TabDAO {
     ...
     */
    static UiDataModel.Tab getSelectedTab(SharedPreferences prefs) {
        final int ordinal = prefs.getInt(KEY_SELECTED_TAB, UiDataModel.Tab.CLOCKS.ordinal());
     ...
     */
    static void setSelectedTab(SharedPreferences prefs, UiDataModel.Tab tab) {
