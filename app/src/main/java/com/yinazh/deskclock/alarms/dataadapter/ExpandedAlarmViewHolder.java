...
package com.yinazh.deskclock.alarms.dataadapter;
...
public final class ExpandedAlarmViewHolder extends AlarmItemViewHolder {
    ...
    @Override
    public Animator onAnimateChange(final RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
                                    long duration) {
